...
# Refs
```{r}
ref_grp_ct = ref_overlap_ct(data,'data/all_TPs.csv','data/potential_FP.csv',
                            'data/full_cosmic.csv')
label_ct = ref_overlap_ct(data,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv',label=T)
```

## Validation data
```{r}
val_ref_ct = ref_overlap_ct(data,'data/validation_TPs.csv','data/validation_FP.csv',
                            'data/val_full_cosmic.csv')
val_label_ct = ref_overlap_ct(data,'data/validation_TPs.csv','data/validation_FP.csv',
                          'data/val_full_cosmic.csv',label=T)
```
...
ref_mu = compare_refs(pval_df,'data/all_TPs.csv','data/potential_FP.csv',
...
grp_results = compare_refs(all_discoveries,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
...
```{r}
ref_sig_val = compare_refs(htest_results,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
...
ref_pwr = compare_refs(pwr_df,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all  %>%
...
high_power_BF_overlap = compare_refs(high_power_BF,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
                      group_by(ref_grp,comparison) %>%
                      tally()
high_power_BY_overlap = compare_refs(high_power_BY,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
                      group_by(ref_grp,comparison) %>%
                      tally()
...
filter_beta= function(crit_b) {
  ...
  if (!is.null(nrow(compare_refs(filtered_data,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$div))) {
    record_overlap = compare_refs(filtered_data,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$div %>%
                          mutate(ref_label = as.factor(ref_label)) %>%
                          group_by(ref_label) %>% tally()
    record_overlap_perc = label_perc_overlap(record_overlap) %>%
...
bayes_disc_overlap = compare_refs(bayes_discoveries,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
...
```{r}
bayes_pwr_df = compare_refs(bayes_discoveries,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
                  mutate(effect_size_h = 2*(asin(sqrt(obs.mu)) - asin(sqrt(E.mu))),
                         power = std_power(effect_size_h),
                         beta = 1-power,
...
ref_ES = compare_refs(ES_df,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
            mutate(ref_grp = factor(ref_grp,levels=c("FP","TP","TN"))) #%>%
...
val_high_ES_results = compare_refs(val_high_ES,'data/validation_all_TPs.csv',
                                   'data/validation_FP.csv',
                                   'data/val_full_cosmic.csv')$all %>%
                mutate(ref_grp = factor(ref_grp,
                                         levels=c("FP","TP","TN"))) %>%
                group_by(ref_grp,comparison) %>% tally()
...
all_riskXq = compare_refs(risks_df,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
...
sig_risk_overlap = compare_refs(sig_risk,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
                      group_by(comparison,ref_grp) %>%
                      tally()
...
all_risk_labeled = compare_refs(all_risk,'data/all_TPs.csv','data/potential_FP.csv',
                          'data/full_cosmic.csv')$all %>%
                      group_by(comparison,ref_grp) %>%
                      tally()
...
val_high_risk_results = compare_refs(val_high_risk,'data/validation_all_TPs.csv',
                                   'data/validation_FP.csv',
                                   'data/val_full_cosmic.csv')$all %>%
                mutate(ref_grp = as.factor(ref_grp)) %>%
                group_by(ref_grp,comparison) %>% tally()
...
val_rXES_results = compare_refs(val_rXES_df,'data/validation_all_TPs.csv',
                                   'data/validation_FP.csv',
                                   'data/val_full_cosmic.csv')$all %>%
                        mutate(ref_grp = as.factor(ref_grp)) %>%
                        group_by(ref_grp,comparison) %>% tally()
